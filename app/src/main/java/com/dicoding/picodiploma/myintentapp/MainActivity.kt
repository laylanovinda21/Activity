...
import com.dicoding.picodiploma.myintentapp.MoveActivity as MoveActivity
    ...
    override fun onClick(v: View?) {
        when(v?.id) {
            ...
            R.id.btn_move_activity_data -> {
                ...
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME, "Novinda Layla")
            ...
            R.id.btn_move_activity_object -> {
                val person = Person(
                    "Novinda Layla", 16, "novindalr@gmail.com", "Wonosobo"
                )
